...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for i = 1:100
        [ratios(i), fval(i)] = fmincon(@(x)1./min(efficiency_range(x,M,N)),(i/100), [], [], [], [], 0, pi, [], opts);        
    end
    
    [~,i] = min(fval);
    ratio = ratios(i);
    eff_Golden = efficiency_range(gr2D,M,N);
    eff_SILVER  = efficiency_range(ratio,M,N);
