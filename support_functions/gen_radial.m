function [k2, wi, varargout] = gen_radial(incr, N_r, N_proj, N_meas, mod_angle, cont, start_spoke, shift, r)
...
%   Generate angles
angles  =   ang_fn(start_spoke:start_spoke+N_proj-1);
...
for i = 1:N_proj*N_meas
   k(:,i)   =   (2*pi)*(r*exp(+1j*pi*angles(i)/180) + shift(1)*cosd(angles(i)) + 1j*shift(2)*sind(angles(i)));
end
